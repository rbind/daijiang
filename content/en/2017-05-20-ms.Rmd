...
Goal: I want to write academic style blog posts with: citations, cross-refernece of tables and figures, and I want to manage figure path by myself. The default setting of blogdown can handle citations and cross-references pretty well, but the figures are nested too deep. I just want to put all figures under `static/figures`.
...
You can also print tablesand cross-refer it with `\@ref(tab:table-label)`, for example Table \@ref(tab:pressure2):
